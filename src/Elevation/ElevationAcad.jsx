  ...
  return (
    <>
      <section className='apply-now-banner-top'>
        <div className='apply-now-banner-top-left'>
      ...
      <section className='forgraduate20222023'>
         <div className='forgraduate20222023-left'>
          <h1>For 2023, 2022 & 2021 graduates</h1>
          <div className='batchstartdiv'>Batch Starting: 1st May 2023</div>
         </div>
         <div className='forgraduate20222023-right'>

          <div  className='forgraduate20222023-right-item-1'>
          ...
          <div  className='forgraduate20222023-right-item-2'>
          <img src="https://s3.ap-south-1.amazonaws.com/www.prepbytes.com/images/elevation-academy/Images/Start+Assesment.webp" alt="" />
            <h4>1:1 Counselling session</h4>
            <p>From 18th April</p>
          </div>
          ...
          <div  className='forgraduate20222023-right-item-3'> <img src="https://s3.ap-south-1.amazonaws.com/www.prepbytes.com/images/elevation-academy/Images/Batch+Starts.webp" alt="" />
            <h4>Free Webinar</h4>
            <p>17 April</p>
            </div>
